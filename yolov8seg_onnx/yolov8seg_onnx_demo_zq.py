...
def detect(img_path):
    ...
    ort_session = ort.InferenceSession('./yolov8nseg_relu_80class_dfl.onnx')
    ...
    for i in range(len(predbox)):
        ...
        cv2.putText(orig, title, ptext, cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
